...
# =====================================================
# =====================================================
# 🔹 SEND OTP FOR PASSWORD RESET (Final Polished Version)
# =====================================================
class SendOTPAPIView(APIView):
    def post(self, request):
        ...
        # Clean, professional message format (no extra spacing)
        message = (
            ...
            "— TCL Forge\n"
            "Tool developed by Kunal Saraswat"
        )
        ...
        try:
            ...
            return Response(
                {"error": f"Failed to send email. SMTP issue: {e}"},
                status=500
            )
